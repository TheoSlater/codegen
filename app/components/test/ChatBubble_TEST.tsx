...
export default function ChatBubble({
  ...
  // Use alpha() for safe transparency handling
  const backgroundColor = isUser
    ? theme.palette.mode === "dark"
      ? alpha(theme.palette.primary.light, 0.12) // ~20 hex transparency
  ...
  const borderColor = isUser
    ? theme.palette.mode === "dark"
      ? alpha(theme.palette.primary.light, 0.2) // ~33 hex transparency
      : "transparent"
    : theme.palette.mode === "dark"
